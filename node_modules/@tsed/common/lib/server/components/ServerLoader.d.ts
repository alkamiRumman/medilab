...
export declare abstract class ServerLoader implements IServerLifecycle {
     ...
     */
    readonly settings: IDIConfigurationOptions & ServerSettingsService;
    /**
    ...
    static bootstrap(module: Type<ServerLoader>, settings?: Partial<IDIConfigurationOptions>): Promise<ServerLoader>;
    /**
     ...
     * @param options
     */
    addComponents(classes: any | any[], options?: any): ServerLoader;
    /**
    ...
    protected resolveProviders(): Promise<void>;
    /**
     * @deprecated
     */
    /**
    ...
    protected setSettings(settings: Partial<IDIConfigurationOptions>): void;
    /**
